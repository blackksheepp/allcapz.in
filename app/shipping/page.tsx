                ...
                <div className="text-accent flex-grow container mx-auto px-4 sm:px-6 lg:px-8 pt-12 lg:pt-20 text-sm sm:text-base">
                    <div className="max-w-4xl mx-auto space-y-6">
                        ...
                        <section>
                            ...
                            <p>If you have any questions regarding your order, please contact us at support@allcapz.in. For more details reach us via our <Link href={"/about#contact"} className="text-green-600 underline">Contact Page</Link>.</p>
                        </section>
                    </div>
                </div>
